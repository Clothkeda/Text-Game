            ...
            using (var reader = ExcelReaderFactory.CreateReader(stream))
            {
                do
                {
                    while (reader.Read())
                    {
                        ...
                        data.character3Action = reader.IsDBNull(12) ? string.Empty : reader.GetValue(12).ToString();
                        data.CoordinateX3 = reader.IsDBNull(13) ? string.Empty : reader.GetValue(13).ToString();
